...
const PRINT = {
  ...
  // на них числа изменятся снова. В v1.15.21 и v1.15.22 менялись только щиты
  // торможения (прижаты к стене, затем возвращены на землю и подняты в высоту
  // до 1.2 м) — отбойник тот же, каждый раз меняется один хеш геометрии.
  Montreal: {
    meshes: 42, tris: 14228, M: 1087, len: 4348.704, hw: 7609,
    wall: '10.06/9.20/1.00/1.00', grid: '319627f8', geo: '9292fcd4',
  },
};
