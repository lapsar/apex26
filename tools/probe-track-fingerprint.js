...
const PRINT = {
  ...
  // Монреаль, 08.2026. Разметка ЧАСТИЧНАЯ: пит-билдинг по контуру OSM и щиты
  // торможения. Барьер и зоны вылета по-прежнему обобщённые — их в OSM нет.
  // Когда появятся, числа изменятся снова, это ожидаемо.
  Montreal: {
    meshes: 42, tris: 14228, M: 1087, len: 4348.704, hw: 7609,
    wall: '10.00/10.00/1.00/1.00', grid: '319627f8', geo: 'b1417371',
  },
};
