...
const PRINT = {
  ...
  // на них числа изменятся снова. В v1.15.21..23 менялись только щиты торможения:
  // прижаты к стене, затем подняты на опору (0.8-2.0 м) — отбойник всё это время
  // тот же. Стойки дали +1 меш и +18 треугольников, это ожидаемо.
  Montreal: {
    meshes: 43, tris: 14246, M: 1087, len: 4348.704, hw: 7609,
    wall: '10.06/9.20/1.00/1.00', grid: '319627f8', geo: 'c1a7bd93',
  },
};
