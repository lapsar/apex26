...
const PRINT = {
  ...
  // на них числа изменятся снова. В v1.15.21..24 менялись только щиты торможения:
  ...
  Montreal: {
    meshes: 43, tris: 14246, M: 1087, len: 4348.704, hw: 7609,
    wall: '10.06/9.20/1.00/1.00', grid: '319627f8', geo: 'f99e6fb7',
  },
};
