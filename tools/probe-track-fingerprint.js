...
const PRINT = {
  ...
  // Монреаль добавлен 08.2026, только полотно: своей разметки ещё нет, мир строится
  // обобщёнными строителями. После разметки (§8) числа изменятся — это ожидаемо.
  Montreal: {
    meshes: 39, tris: 14186, M: 1087, len: 4348.704, hw: 7609,
    wall: '10.00/10.00/1.00/1.00', grid: '319627f8', geo: 'b7f67fd5',
  },
};
