...
const PRINT = {
  ...
  // v1.15.28: свои трибуны вместо обобщённых заглушек — шесть штук по обмеру
  // спутника. Мешей 43 -> 42 (заглушки давали два меша, размеченные дают один),
  // треугольников 15380 -> 17696. Длина круга, профиль полуширины, отбойник
  // и все 22 клетки решётки не изменились: полотна правка не касается.
  // Прошлые числа: 43 меша, 15380 тр., geo fd2a5f29.
  Montreal: {
    meshes: 42, tris: 17696, M: 1087, len: 4348.704, hw: 7609,
    wall: '10.06/9.20/1.00/1.00', grid: '319627f8', geo: '1b35d60d',
  },
};
