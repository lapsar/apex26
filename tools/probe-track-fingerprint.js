...
const PRINT = {
  ...
  // на них числа изменятся снова. В v1.15.21 сдвинулись только щиты торможения
  // (прижаты к стене и подняты над ней) — отбойник тот же, изменился один хеш.
  Montreal: {
    meshes: 42, tris: 14228, M: 1087, len: 4348.704, hw: 7609,
    wall: '10.06/9.20/1.00/1.00', grid: '319627f8', geo: 'e6a526c6',
  },
};
