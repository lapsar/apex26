...
// Майами открыта в меню в v1.15.83. 40 мешей: обобщённое окружение плюс меш перемычек
// барьера, появившийся вместе с защитой от складывания. Своей разметки у неё ещё нет.
const SCENE_BUDGET = { Monza: 43, Silverstone: 46, Montreal: 42, Miami: 40 };
