...
// Хунгароринг 39 -> 41 в v1.16.6 (этап 2): пит-билдинг и девять трибун. Их материалы
// (сиденья, каркас, стены и остекление здания) общие для всей разметки, а трибуны-заглушки
// обобщённого мира выключились сами. Было 40 -> 39 в v1.16.5 (панель разрыва в шикане 6-7).
// Хунгароринг 41 -> 43 в v1.16.7 (этап 3): зоны вылета асфальт и гравий, по материалу на
// сторону (+4), обобщённый гравий выключился сам (−2). В гонке 492 вызова при потолке 495.
const SCENE_BUDGET = { Monza: 43, Silverstone: 46, Montreal: 42, Miami: 45, Hungaroring: 43 };
