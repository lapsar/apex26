#!/usr/bin/env python3
"""Развернуть круг ХУНГАРОРИНГА в ленту: для каждой станции S — поперечный срез снимка.
...
O = dict(lat0=47.582732616, lon0=19.250829443, mlon=75088.112675, mlat=110540)   # SCEN_ORIGIN.Hungaroring
SRC = {
