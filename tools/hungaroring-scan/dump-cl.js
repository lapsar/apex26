/* Осевая Хунгароринга ИЗ ИГРЫ в centerline.json: P, S, K, длина круга.
...
const o=JSON.parse(env.evalIn(`(function(){
  var o={M:track.M,len:track.length,half:track.roadHalf,P:[],S:track.S.slice(),K:track.K.slice()};
  for(var i=0;i<track.M;i++) o.P.push([track.P[i].x,track.P[i].z]);
