#!/usr/bin/env python3
"""Развернуть круг МАЙАМИ в ленту: для каждой станции S — поперечный срез снимка.
...
O = json.load(open(os.path.join(HERE, 'centerline.json')))['geo']   # привязка приходит из dump-cl.js, а не хардкодом
SRC = {
