...
col = PAD + 1180;
const notes = ['Серым — то, что осталось коробками: боксы и паддок через линию',
  'старта и Hard Rock Stadium (274 × 260 м, контур из OSM).',
  'Гостевые постройки — клубы, ложи и виллы — с v1.15.95 стоят',
  'ТРИБУНАМИ: роль у них та же, а глухая стена сливалась с бортом.',
  'В v1.15.96 две из них (The 72 Club и The Palm Club, по 44 м)',
  'убраны: у стадиона они читались обрезками.',
  '',
