/* ============================================================================
   ...
   Игрок — Стролл (самый слабый в ростере): его пилот из числа соперников
   выбывает, и так в поле остаются все семь лидеров и оба пилота силы 0.85,
   ради которых пробник и написан. Поле поэтому 21 болид, а не 22.
...
const WEAK = 0.86;           // сила, ниже которой пилот считается слабым
